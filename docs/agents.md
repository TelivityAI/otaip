...
>
> **Agent connections:** open [agent-map.html](./agent-map.html) (generated by `pnpm gen:manifest`) or use **Map** on the Platform UI dashboard. Shows how agents wire through workflows — not a travel-domain knowledge graph.
